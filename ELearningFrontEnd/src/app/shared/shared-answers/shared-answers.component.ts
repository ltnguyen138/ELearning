...
@Component({
    selector: 'app-shared-answers',
    templateUrl: './shared-answers.component.html',
    styleUrls: ['./shared-answers.component.css'],
    animations: [
        trigger('slideToggle', [
            transition(':enter', [
...
export class SharedAnswersComponent implements OnInit,  AfterViewInit, OnChanges{
    ...
    onDelByAdmin(): void {
        this.deleteByAdmin.emit(this.answer.id);
    }
